...
```
cline:       name                   (required; provided by scientist)
description: some description       (required; provided by scientist)
experiment:  name                   (required; provided by scientist)
replicate:   1                      (required; provided by scientist)
resolution:  100000                 (required; provided by scientist)
timeunits:   hr                     (required; provided by scientist)
timevalues:  [24, 48, ..., N]       (required; provided by scientist)
treatments:  [one, two]             (required: provided by scientist)
```
...
datasets:
  ...
  -   - /path/to/filename1.0.fastq  (extracted from experimental_design.csv)
      - /path/to/filename1.1.fastq  (extracted from experimental_design.csv)
      - ...
      - /path/to/filename1.N.fastq  (extracted from experimental_design.csv)
description: some description       (required; provided by scientist)
experiment:  name                   (required; provided by scientist)
replicate:   1                      (required; provided by scientist)
resolution:  100000                 (required; provided by scientist)
...
timevalues:  [24, 48, ..., N]       (required; provided by scientist)
treatments:  [one, two]             (required: provided by scientist)
version:     x.x                    (automatically generated by the workflow)
```
