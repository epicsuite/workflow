...
if __name__ == "__main__":
    ...
    parser.add_argument("-q", "--fastqdir",       dest="q",       type=str,  required=True,  help = 'Directory with input fastqs', metavar = 'path/to/fastqs/dir',    default = None         )
    ...
    fastqdir        = inputs.q            ##     Sets the input fastq directory path
